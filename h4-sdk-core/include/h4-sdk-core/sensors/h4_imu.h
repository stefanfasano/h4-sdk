...
class h4_imu : public abstract_imu, soem_interface_rsl::EthercatSlaveBase
{
  ...
  public:
  explicit h4_imu(const std::string& name, soem_interface_rsl::EthercatBusBase* bus, const uint32_t& address);
