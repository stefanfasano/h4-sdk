...
#include "h4-sdk-core/sensors/h4_imu.h"
#include <string>

h4_imu::h4_imu(const std::string &name, soem_interface_rsl::EthercatBusBase* bus, const uint32_t &address)
: abstract_imu(name), EthercatSlaveBase(bus, address)
{
